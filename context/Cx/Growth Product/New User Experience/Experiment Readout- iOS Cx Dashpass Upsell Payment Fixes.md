...
| --- | --- |
| ![Drawing 1](Experiment-Readout-iOS-Cx-Dashpass-Upsell-Payment-Fixes/images/image_8.png)![Drawing 2](Experiment-Readout-iOS-Cx-Dashpass-Upsell-Payment-Fixes/images/image_10.png)<br>**Cart + Checkout (No Upsell)**| The cart and checkout DashPass upsells are**hidden**to New Cx who have not setup a payment method.<br>*Example Upsell Shown:*<br>![Drawing 3](Experiment-Readout-iOS-Cx-Dashpass-Upsell-Payment-Fixes/images/image_4.png) |
| ![Drawing 4](Experiment-Readout-iOS-Cx-Dashpass-Upsell-Payment-Fixes/images/image_2.png)![Drawing 5](Experiment-Readout-iOS-Cx-Dashpass-Upsell-Payment-Fixes/images/image_9.png)![Drawing 6](Experiment-Readout-iOS-Cx-Dashpass-Upsell-Payment-Fixes/images/image_5.png)<br>**Feed Banner + Account → Payment Error**| All DP entry points (Except for Onboarding) show payment error for New Cx (w/o payment selected)<br>Feed Banner<br>Account Page Upsell |**Results Summary**The DashPass Upsell Default Payment fix drove <mark>22,000</mark> incremental DP Trial Signups over a 1 week experiment period,**leading to +1.1M DashPass trial signups.**- DashPass Trial Starts:**+1.1M/yr (+15% rel)**
...
| --- | --- |
| ![Drawing 7](Experiment-Readout-iOS-Cx-Dashpass-Upsell-Payment-Fixes/images/image_1.png)![Drawing 8](Experiment-Readout-iOS-Cx-Dashpass-Upsell-Payment-Fixes/images/image_3.png)<br>**Cart + Checkout** | All entry points now allow for trial signup without fail.<br>Cart and Checkout Banners are now successfully shown. |
| ![Drawing 9](Experiment-Readout-iOS-Cx-Dashpass-Upsell-Payment-Fixes/images/image_12.png)![Drawing 10](Experiment-Readout-iOS-Cx-Dashpass-Upsell-Payment-Fixes/images/image_7.png)![Drawing 11](Experiment-Readout-iOS-Cx-Dashpass-Upsell-Payment-Fixes/images/image_6.png)<br>**Feed Banner + Account → Successful Signup**| All DP entry points now allow for seamless DP Signup (without selected payment method)<br>Feed Banner<br>Account Page Upsell |
...
![Drawing 12](Experiment-Readout-iOS-Cx-Dashpass-Upsell-Payment-Fixes/images/drawing_11_thumbnail.png)
