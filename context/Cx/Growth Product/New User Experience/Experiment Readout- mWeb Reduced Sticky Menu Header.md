...
| --- | --- | --- |
| ![Drawing 1](Experiment-Readout-mWeb-Reduced-Sticky-Menu-Header/images/image_3.png) | ![Drawing 2](Experiment-Readout-mWeb-Reduced-Sticky-Menu-Header/images/image_1.png) | ![Drawing 3](Experiment-Readout-mWeb-Reduced-Sticky-Menu-Header/images/image_2.png) |**Results Summary**The mWeb Reduced Sticky Menu Header Experiment drove $<mark>335k</mark> incremental GMV over a 3 week experiment period,**leading to an estimated +$2.9M**[^1]**GMV/year**- Estimated annualized GMV:**$2.9M/year**
...
![Drawing 4](Experiment-Readout-mWeb-Reduced-Sticky-Menu-Header/images/drawing_4_thumbnail.png)
