...
The `m_store_content_page_load` table in the IGUAZU catalog captures detailed data on user interactions with store content pages, focusing on engagement and performance metrics. This table is primarily utilized by the Service Metamorph team to analyze user behavior, optimize content delivery, and improve overall user experience on the platform. Key use cases include tracking page load times, user demographics, and interaction patterns, which inform strategic decisions for enhancing service offerings. The table is maintained by the Service Metamorph team, ensuring data accuracy and relevance for ongoing analytics efforts.
...
|--------------|-------------|
| proddb.public.fact_dedup_experiment_exposure | 170 |
| proddb.public.explore_page | 160 |
| segment_events_raw.consumer_production.m_logout | 147 |
| proddb.public.mau | 118 |
| segment_events_raw.consumer_production.be_login_success | 118 |
| segment_events_raw.consumer_production.social_login_new_user | 118 |
| segment_events_raw.consumer_production.m_login_continue_with_saved_account_success | 118 |
| segment_events_raw.consumer_production.be_signup_success | 118 |
| segment_events_raw.consumer_production.social_login_success | 118 |
| proddb.public.dimension_deliveries | 118 |

### Column Metadata

| Usage Rank | Column Name | Queries | Ordinal | Data Type | Is Cluster Key | Comment |
|------------|-------------|---------|---------|-----------|----------------|---------|
| 1 | NAME | 254 | 142 | TEXT | 0 | No comment |
| 2 | DD_DEVICE_ID | 242 | 80 | TEXT | 0 | No comment |
| 3 | DEVICE_ID | 242 | 93 | TEXT | 0 | No comment |
| 4 | PAGE | 193 | 148 | TEXT | 0 | No comment |
| 5 | IGUAZU_USER_ID | 103 | 2 | TEXT | 0 | No comment |
| 6 | CONTEXT_DEVICE_TYPE | 71 | 26 | TEXT | 0 | No comment |
| 7 | EVENT_DATE | 71 | 98 | TEXT | 0 | No comment |
| 8 | CONTEXT | 61 | 74 | TEXT | 0 | No comment |
| 9 | IGUAZU_TIMESTAMP | 40 | 6 | TIMESTAMP_NTZ | 0 | No comment |
| 10 | CONTEXT_USER_AGENT | 38 | 61 | TEXT | 0 | No comment |
| 11 | CONTEXT_PAGE_PATH | 36 | 38 | TEXT | 0 | No comment |
...
| 17 | DD_SESSION_ID | 34 | 88 | TEXT | 0 | No comment |
| 18 | CONTEXT_TIMEZONE | 33 | 46 | TEXT | 0 | No comment |
| 19 | DD_PLATFORM | 33 | 87 | TEXT | 0 | No comment |
| 20 | SUBMARKET_ID | 33 | 179 | TEXT | 0 | No comment |
| 21 | CONSUMER_ID | 22 | 72 | TEXT | 0 | No comment |
| 22 | ZIP_CODE | 18 | 191 | TEXT | 0 | No comment |
| 23 | CONTEXT_OS_NAME | 17 | 36 | TEXT | 0 | No comment |
| 24 | DD_SUBMARKET_ID | 15 | 89 | TEXT | 0 | No comment |
| 25 | CONTEXT_TRAITS_ZIP_CODE | 12 | 60 | TEXT | 0 | No comment |
| 26 | RESULT | 12 | 158 | TEXT | 0 | No comment |
| 27 | PAGE_TYPE | 9 | 150 | TEXT | 0 | No comment |
| 28 | CONTEXT_APP_VERSION | 7 | 14 | TEXT | 0 | No comment |
| 29 | APP_VERSION | 7 | 65 | TEXT | 0 | No comment |
| 30 | CONTEXT_DEVICE_ID | 6 | 22 | TEXT | 0 | No comment |
| 31 | LOCALE | 6 | 138 | TEXT | 0 | No comment |
| 32 | IGUAZU_ID | 5 | 1 | TEXT | 0 | No comment |
| 33 | IGUAZU_RECEIVED_AT | 5 | 8 | TIMESTAMP_NTZ | 1 | No comment |
| 34 | CONTEXT_APP_NAME | 5 | 12 | TEXT | 0 | No comment |
| 35 | CONTEXT_APP_NAMESPACE | 5 | 13 | TEXT | 0 | No comment |
| 36 | DD_ZIP_CODE | 5 | 91 | TEXT | 0 | No comment |
| 37 | IGUAZU_EVENT | 3 | 3 | TEXT | 0 | No comment |
| 38 | IGUAZU_ANONYMOUS_ID | 2 | 4 | TEXT | 0 | No comment |
| 39 | IGUAZU_ORIGINAL_TIMESTAMP | 2 | 5 | TIMESTAMP_NTZ | 0 | No comment |
| 40 | IGUAZU_SENT_AT | 2 | 7 | TIMESTAMP_NTZ | 0 | No comment |
| 41 | IGUAZU_OTHER_PROPERTIES | 2 | 9 | VARIANT | 0 | No comment |
| 42 | IGUAZU_INGEST_TIMESTAMP | 2 | 10 | TIMESTAMP_NTZ | 0 | No comment |
| 43 | CONTEXT_APP_BUILD | 2 | 11 | TEXT | 0 | No comment |
...
| 58 | CONTEXT_LOCALE | 2 | 31 | TEXT | 0 | No comment |
| 59 | CONTEXT_NETWORK_BLUETOOTH | 2 | 32 | BOOLEAN | 0 | No comment |
| 60 | CONTEXT_NETWORK_CARRIER | 2 | 33 | TEXT | 0 | No comment |
| 61 | CONTEXT_NETWORK_CELLULAR | 2 | 34 | BOOLEAN | 0 | No comment |
| 62 | CONTEXT_NETWORK_WIFI | 2 | 35 | BOOLEAN | 0 | No comment |
| 63 | CONTEXT_OS_VERSION | 2 | 37 | TEXT | 0 | No comment |
...
| 71 | CONTEXT_TRAITS_ANONYMOUS_ID | 2 | 47 | TEXT | 0 | No comment |
| 72 | CONTEXT_TRAITS_CITY | 2 | 48 | TEXT | 0 | No comment |
| 73 | CONTEXT_TRAITS_EMAIL | 2 | 49 | TEXT | 0 | No comment |
| 74 | CONTEXT_TRAITS_FIRST_NAME | 2 | 50 | TEXT | 0 | No comment |
| 75 | CONTEXT_TRAITS_LAST_NAME | 2 | 51 | TEXT | 0 | No comment |
| 76 | CONTEXT_TRAITS_LATITUDE | 2 | 52 | FLOAT | 0 | No comment |
| 77 | CONTEXT_TRAITS_LONGITUDE | 2 | 53 | FLOAT | 0 | No comment |
| 78 | CONTEXT_TRAITS_NAME | 2 | 54 | TEXT | 0 | No comment |
| 79 | CONTEXT_TRAITS_ORDERS_COUNT | 2 | 55 | NUMBER | 0 | No comment |
| 80 | CONTEXT_TRAITS_STATE | 2 | 56 | TEXT | 0 | No comment |
| 81 | CONTEXT_TRAITS_STORE_ID | 2 | 57 | TEXT | 0 | No comment |
| 82 | CONTEXT_TRAITS_SUBMARKET | 2 | 58 | TEXT | 0 | No comment |
| 83 | CONTEXT_TRAITS_SUBMARKET_ID | 2 | 59 | TEXT | 0 | No comment |
| 84 | ALL_BANNER_DATA | 2 | 62 | TEXT | 0 | No comment |
| 85 | ALL_VERTICAL_IDS | 2 | 63 | TEXT | 0 | No comment |
| 86 | ALL_VERTICALS_COUNT | 2 | 64 | TEXT | 0 | No comment |
| 87 | BANNER_COUNT | 2 | 66 | NUMBER | 0 | No comment |
| 88 | CACHE_HIT | 2 | 67 | TEXT | 0 | No comment |
| 89 | CAROUSEL_COUNT | 2 | 68 | NUMBER | 0 | No comment |
| 90 | CAROUSEL_NAMES | 2 | 69 | TEXT | 0 | No comment |
| 91 | CITY | 2 | 70 | TEXT | 0 | No comment |
| 92 | COMPONENT | 2 | 71 | TEXT | 0 | No comment |
| 93 | CONTENT_LOADED | 2 | 73 | BOOLEAN | 0 | No comment |
| 94 | COUNTRY_CODE | 2 | 75 | TEXT | 0 | No comment |
| 95 | CURSOR | 2 | 76 | TEXT | 0 | No comment |
| 96 | DD_ANDROID_ADVERTISING_ID | 2 | 77 | TEXT | 0 | No comment |
| 97 | DD_ANDROID_ID | 2 | 78 | TEXT | 0 | No comment |
| 98 | DD_DELIVERY_CORRELATION_ID | 2 | 79 | TEXT | 0 | No comment |
| 99 | DD_DISTRICT_ID | 2 | 81 | NUMBER | 0 | No comment |
| 100 | DD_DISTRICT_IF | 2 | 82 | NUMBER | 0 | No comment |
| 101 | DD_IOS_IDFA_ID | 2 | 83 | TEXT | 0 | No comment |
| 102 | DD_IOS_IDFV_ID | 2 | 84 | TEXT | 0 | No comment |
| 103 | DD_IOS_IFV_ID | 2 | 85 | TEXT | 0 | No comment |
| 104 | DD_LOGIN_ID | 2 | 86 | TEXT | 0 | No comment |
| 105 | DD_USER_ID | 2 | 90 | NUMBER | 0 | No comment |
| 106 | DECODING_TIME | 2 | 92 | TEXT | 0 | No comment |
| 107 | DOORDASH_CANARY_ALWAYS | 2 | 94 | TEXT | 0 | No comment |
| 108 | DRINKS_ENABLED | 2 | 95 | BOOLEAN | 0 | No comment |
| 109 | ELIGIBLE_VERTICAL_IDS | 2 | 96 | TEXT | 0 | No comment |
| 110 | ELIGIBLE_VERTICALS_COUNT | 2 | 97 | TEXT | 0 | No comment |
| 111 | EVENT_RESULT | 2 | 100 | TEXT | 0 | No comment |
| 112 | EVENT_TEXT | 2 | 101 | TEXT | 0 | No comment |
| 113 | FILTER | 2 | 103 | TEXT | 0 | No comment |
| 114 | FILTER_QUERIES | 2 | 104 | TEXT | 0 | No comment |
| 115 | FILTERS_APPLIED | 2 | 105 | TEXT | 0 | No comment |
| 116 | FLASH_COUNT | 2 | 106 | NUMBER | 0 | No comment |
| 117 | GIFT_INTENT | 2 | 107 | TEXT | 0 | No comment |
| 118 | HAS_ADDRESS_VALIDATION_INFO | 2 | 108 | BOOLEAN | 0 | No comment |
| 119 | HAS_AVAILABLE_STORES | 2 | 109 | BOOLEAN | 0 | No comment |
| 120 | HAS_ENTRY_CODE | 2 | 110 | BOOLEAN | 0 | No comment |
| 121 | HAS_INSTRUCTIONS | 2 | 111 | BOOLEAN | 0 | No comment |
| 122 | HAS_PARKING_INSTRUCTIONS | 2 | 112 | BOOLEAN | 0 | No comment |
| 123 | HOMEPAGE_NAVIGATION_TYPE | 2 | 113 | TEXT | 0 | No comment |
| 124 | IGUAZU_COMMON_ID | 2 | 114 | TEXT | 0 | No comment |
| 125 | INTEGRATIONS_ADJUST | 2 | 115 | BOOLEAN | 0 | No comment |
| 126 | INTEGRATIONS_ALL | 2 | 116 | BOOLEAN | 0 | No comment |
| 127 | INTEGRATIONS_AMAZON_KINESIS_FIREHOSE | 2 | 117 | BOOLEAN | 0 | No comment |
| 128 | INTEGRATIONS_FIREBASE | 2 | 118 | BOOLEAN | 0 | No comment |
| 129 | INTEGRATIONS_GOOGLE_TAG_MANAGER | 2 | 119 | BOOLEAN | 0 | No comment |
| 130 | INTEGRATIONS_IMPACT_PARTNERSHIP_CLOUD | 2 | 120 | BOOLEAN | 0 | No comment |
| 131 | INTEGRATIONS_OPTIMIZELY | 2 | 121 | BOOLEAN | 0 | No comment |
| 132 | INTEGRATIONS_OPTIMIZELY_WEB | 2 | 122 | BOOLEAN | 0 | No comment |
| 133 | INTEGRATIONS_TV_SQUARED | 2 | 123 | BOOLEAN | 0 | No comment |
| 134 | INTEGRATIONS_TWITTER_ADS | 2 | 124 | BOOLEAN | 0 | No comment |
| 135 | IS_EXPLORE_FEED | 2 | 125 | BOOLEAN | 0 | No comment |
| 136 | IS_FILTER_APPLIED | 2 | 126 | TEXT | 0 | No comment |
| 137 | IS_GUEST | 2 | 127 | TEXT | 0 | No comment |
| 138 | IS_GUEST_CONSUMER | 2 | 128 | BOOLEAN | 0 | No comment |
| 139 | IS_HYBRID_SEARCH | 2 | 129 | TEXT | 0 | No comment |
| 140 | IS_PAGINATION | 2 | 130 | TEXT | 0 | No comment |
| 141 | IS_REWRITE | 2 | 131 | TEXT | 0 | No comment |
| 142 | IS_VOICE_OVER_RUNNING | 2 | 132 | TEXT | 0 | No comment |
| 143 | ITEM_COUNT | 2 | 133 | NUMBER | 0 | No comment |
| 144 | LAT | 2 | 134 | FLOAT | 0 | No comment |
| 145 | LATITUDE | 2 | 135 | FLOAT | 0 | No comment |
| 146 | LNG | 2 | 136 | FLOAT | 0 | No comment |
| 147 | LOAD_TIME | 2 | 137 | NUMBER | 0 | No comment |
| 148 | LOGGING_ERROR | 2 | 139 | TEXT | 0 | No comment |
| 149 | LONGITUDE | 2 | 140 | FLOAT | 0 | No comment |
| 150 | MARKET | 2 | 141 | TEXT | 0 | No comment |
| 151 | NETWORK_RESPONSE_TIME | 2 | 143 | TEXT | 0 | No comment |
| 152 | NUM_CAROUSELS | 2 | 144 | TEXT | 0 | No comment |
| 153 | NUM_IN_STORE_FEED | 2 | 145 | TEXT | 0 | No comment |
| 154 | NUM_TILES | 2 | 147 | TEXT | 0 | No comment |
| 155 | PAGE_ID | 2 | 149 | TEXT | 0 | No comment |
...
### Query 1
**Last Executed:** 2025-08-08 15:19:40.076000

```sql
WITH exposure AS
(SELECT DISTINCT ee.tag
               , ee.result
               , ee.bucket_key AS dd_device_ID
...
, refresh_failure AS
(SELECT DISTINCT DD_DEVICE_ID 
        , convert_timezone('UTC','America/Los_Angeles',iguazu_timestamp)::date AS day
FROM iguazu.consumer.M_IDENTITY_TOKEN_REFRESH_FAILURE_ice
WHERE event = 'startup_recoverable_error'
...
(SELECT DISTINCT DD_DEVICE_ID 
        , convert_timezone('UTC','America/Los_Angeles',iguazu_timestamp)::date AS day
FROM iguazu.consumer.m_identity_back_refresh_v2_ice
WHERE convert_timezone('UTC','America/Los_Angeles',iguazu_timestamp) BETWEEN $start_date AND $end_date
)

, res AS
(SELECT tag
        , COUNT(DISTINCT e.dd_device_ID) AS exposure
        , COUNT(DISTINCT rf.dd_device_ID) AS refresh_failure
        , COUNT(DISTINCT rn.dd_device_ID) AS refresh_new
FROM exposure e 
LEFT JOIN refresh_failure rf 
  ON e.dd_device_ID = rf.dd_device_ID 
  AND e.day <= rf.day
LEFT JOIN refresh_new rn
  ON e.dd_device_ID = rn.dd_device_ID 
  AND e.day <= rn.day
GROUP BY 1
)
...
SELECT r.*
      ...
      , er.explore_rate
FROM res r 
LEFT JOIN explore_res er 
  ON r.tag = er.tag
LIMIT 100
-- {"user":"@heming_chen","email":"heming.chen@doordash.com","url":"https://modeanalytics.com/doordash/reports/e321e26e1e57/runs/29e4f6835488/queries/a7c32c8253ba","scheduled":false}
```

### Query 2
**Last Executed:** 2025-08-08 10:06:16.864000
...
LEFT JOIN res r2
    ...
    AND r2.tag = 'control'
ORDER BY 1 desc, 2
-- {"user":"@heming_chen","email":"heming.chen@doordash.com","url":"https://modeanalytics.com/doordash/reports/dd96bdd8c892/runs/1aaed506c18e/queries/9d7796280066","scheduled":false}
```


## Related Documentation

- [Symbiosys Feeds](https://doordash.atlassian.net/wiki/wiki/search?text=iguazu.server_events_production.m_store_content_page_load)
- [Entrypoint Management + Troubleshooting FAQ](https://doordash.atlassian.net/wiki/wiki/search?text=iguazu.server_events_production.m_store_content_page_load)
- [[FUV] fact_unique_visitors_full_pt/utc - Development &amp; Engineering](https://doordash.atlassian.net/wiki/wiki/search?text=iguazu.server_events_production.m_store_content_page_load)
