...
**Database:** iguazu
**Schema:** consumer
**Table:** m_onboarding_page_click_ice
**Owner:** SERVICE_CASPIAN
**Row Count:** 20,323,279 rows
**Created:** 2025-03-18 00:02:06.377000+00:00
**Last Modified:** 2025-07-17 17:27:09.549000+00:00

**Description:** None

## Business Context

The "M_ONBOARDING_PAGE_CLICK_ICE" table in the IGUAZU consumer schema captures detailed interactions from users during the onboarding process, including page clicks, device identifiers, and timestamps. This data is crucial for understanding user engagement and optimizing the onboarding experience, making it valuable for marketing and product development teams. The table is maintained by the SERVICE_CASPIAN team, ensuring that the data remains accurate and up-to-date for analysis.
...
**Raw Row Count:** 20,323,279

### Most Common Joins

| Joined Table | Query Count |
|--------------|-------------|
| iguazu.consumer.m_onboarding_end_promo_page_click_ice | 51 |
| iguazu.consumer.m_onboarding_end_promo_page_view_ice | 50 |
| iguazu.consumer.m_onboarding_start_promo_page_view_ice | 46 |
...
|------------|-------------|---------|---------|-----------|----------------|---------|
| 1 | PAGE | 53 | 30 | TEXT | 0 | No comment |
| 2 | DD_DEVICE_ID | 51 | 5 | TEXT | 0 | No comment |
| 3 | DEVICE_ID | 51 | 14 | TEXT | 0 | No comment |
| 4 | IGUAZU_TIMESTAMP | 40 | 113 | TIMESTAMP_NTZ | 0 | No comment |
| 5 | DD_PLATFORM | 14 | 10 | TEXT | 0 | No comment |
