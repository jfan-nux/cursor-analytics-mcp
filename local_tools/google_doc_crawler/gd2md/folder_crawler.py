...
class GoogleDriveFolderCrawler:
    ...
    def process_folder(
        ...
        Args:
            ...
            subfolder_path: Optional subfolder path to navigate to in Google Drive (e.g., "Cx/Growth Product/New User Experience")
            local_output_path: Local directory path for markdown output (default: "context")
