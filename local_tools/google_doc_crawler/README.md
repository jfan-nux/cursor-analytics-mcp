...
./utils/google_doc_crawler/gd2md/convert_docs.py \
...
./utils/google_doc_crawler/md2gd/sync_cli.py export my_analysis.md

# Subsequent exports update the same Doc
./utils/google_doc_crawler/md2gd/sync_cli.py export my_analysis.md

# Export without opening browser
./utils/google_doc_crawler/md2gd/sync_cli.py export my_analysis.md --no-browser
```
...
./utils/google_doc_crawler/md2gd/sync_cli.py export analysis_with_images.md
```
...
./utils/google_doc_crawler/md2gd/sync_cli.py import my_analysis.md

# Import without creating backup
./utils/google_doc_crawler/md2gd/sync_cli.py import my_analysis.md --no-backup
```
...
```bash
# Link using full URL
./utils/google_doc_crawler/md2gd/sync_cli.py link \
  my_analysis.md \
...
```bash
./utils/google_doc_crawler/md2gd/sync_cli.py status my_analysis.md
```
...
```bash
./utils/google_doc_crawler/md2gd/sync_cli.py list
```

#### Unlink File

```bash
./utils/google_doc_crawler/md2gd/sync_cli.py unlink my_analysis.md
```
...
./utils/google_doc_crawler/md2gd/sync_cli.py export overview.md
...
# 5. Export to the tab:
./utils/google_doc_crawler/md2gd/sync_cli.py export analysis.md
...
./utils/google_doc_crawler/md2gd/sync_cli.py import analysis.md
...
6. Copy contents of `utils/google_doc_crawler/md2gd/apps_script_processor.gs`
...
```bash
./utils/google_doc_crawler/md2gd/sync_cli.py export test_file.md
```
...
./utils/google_doc_crawler/gd2md/convert_docs.py --doc-url URL --output path
```
...
```bash
./utils/google_doc_crawler/md2gd/sync_cli.py link my_file.md DOC_URL
```
...
- Re-link with the correct tab URL:
  ```bash
  ./utils/google_doc_crawler/md2gd/sync_cli.py link file.md NEW_TAB_URL
  ```
...
```bash
python utils/google_doc_crawler/gd2md/check_access.py
...
./utils/google_doc_crawler/gd2md/convert_docs.py --doc-url URL --output PATH
./utils/google_doc_crawler/gd2md/convert_docs.py --folder-url URL --output PATH
./utils/google_doc_crawler/gd2md/convert_docs.py --doc-list FILE --output PATH

# Export: Markdown → Google Docs (create or update)
./utils/google_doc_crawler/md2gd/sync_cli.py export MARKDOWN_FILE
./utils/google_doc_crawler/md2gd/sync_cli.py export MARKDOWN_FILE --no-browser

# Import: Pull changes from Google Docs (reverse sync)
./utils/google_doc_crawler/md2gd/sync_cli.py import MARKDOWN_FILE
./utils/google_doc_crawler/md2gd/sync_cli.py import MARKDOWN_FILE --no-backup

# Link Management
./utils/google_doc_crawler/md2gd/sync_cli.py link MARKDOWN_FILE DOC_URL [--tab-id ID]
./utils/google_doc_crawler/md2gd/sync_cli.py link MARKDOWN_FILE DOC_ID  # Just ID works too
./utils/google_doc_crawler/md2gd/sync_cli.py status MARKDOWN_FILE
./utils/google_doc_crawler/md2gd/sync_cli.py list
./utils/google_doc_crawler/md2gd/sync_cli.py unlink MARKDOWN_FILE
```
...
```bash
# General help
./utils/google_doc_crawler/gd2md/convert_docs.py --help
./utils/google_doc_crawler/md2gd/sync_cli.py --help

# Command-specific help
./utils/google_doc_crawler/md2gd/sync_cli.py export --help
./utils/google_doc_crawler/md2gd/sync_cli.py link --help
```
...
- Test access: `python utils/google_doc_crawler/gd2md/check_access.py`
...
# Check status
./utils/google_doc_crawler/md2gd/sync_cli.py status test_file.md
