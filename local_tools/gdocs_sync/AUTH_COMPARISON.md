...
# First run
python utils/gdocs_sync/md2gd/sync_cli.py export my_file.md
...
python utils/gdocs_sync/gd2md/convert_docs.py --doc-url URL --output path
...
python utils/gdocs_sync/md2gd/sync_cli.py export file.md
